...
def scan_i2c_loop(bus_id=1, interval=30):
...
def build_dashboard_health_panel():
    ...
    # 📁 Log File Access
    try:
        _ = load_watering_notes()
        lines.append(Text("watering_log.json: [green]Accessible[/green]"))
    except Exception as e:
        lines.append(Text(f"watering_log.json: [red]Error[/red] {str(e)}"))
