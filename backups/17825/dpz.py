...
# BME280 sensor stats (Pressure moved to environment panel)
...
def build_dashboard():
    ...
    layout.add_row(get_as7341_panel(), build_environment_panel())
    return layout
