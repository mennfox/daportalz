...
def build_dashboard(watchdog_config):
    ...
    system_grid.add_row(get_system_panel(), get_cpu_panel())
    system_grid.add_row(get_memory_panel(), get_disk_panel())
#    system_grid.add_row(get_network_panel(), Panel(Text(""), border_style="grey37"))  # Optional filler
    system_grid.add_row(get_network_panel(), build_i2c_panel())
